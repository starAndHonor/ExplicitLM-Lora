...
#   PHASE1_CKPT=/abs/path/to/phase1_best bash scripts/run_scheme1_p1_p2_p3.sh
#
# 环境变量：
...
echo "[Scheme1] Step 2/3: Phase 2 with Phase 1 retrieval"
NUM_GPUS="${NUM_GPUS}" GPU_IDS="${GPU_IDS}" \
...
echo "[Scheme1] Step 3/3: Phase 3 SFT with Phase 1 retrieval"
NUM_GPUS="${NUM_GPUS}" GPU_IDS="${GPU_IDS}" \
KNOWLEDGE_SOURCE=phase1_router \
FROM_PHASE1="${PHASE1_CKPT}" \
